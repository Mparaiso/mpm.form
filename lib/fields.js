...
fields.Base.prototype.validate = function (callback) {
    ...
    if(this.options.validators instanceof validation.validators.Base){
...
fields.Repeated=function(name,options){
    ...
    this.type = "repeated";
    this.options = _.extend({},options,this.constructor.defaultOptions);
};
fields.Repeated.defautOptions = {
    'type':fields.Text,
    'invalid_message':'fields must match',
    'required':true,
    first_options:{},
    second_options:{}
};
fields.Repeated.prototype=new fields.Base();
fields.Repeated.prototype.constructor= fields.Base;
