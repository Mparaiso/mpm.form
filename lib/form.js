 ...
 * @returns {*}
 */
form.FieldLoader.prototype.getField = function (type, name, options) {
    switch (type) {
        case "password":
 ...
 * @constructor
 */
form.FormBuilder = function (name,model) {
    this._fields = [];
    this.fieldLoaders = [];
    this._name = name;
 ...
 * @returns {*}
 */
form.FormBuilder.prototype.add = function (type, name, options) {
...
form.FormBuilder.prototype.addField=form.FormBuilder.prototype.add;
/**
 *
...
form.FormBuilder.prototype.getFields=function(){return this._fields;};
/**
 *
 * @param callback
 * @returns {*}
...
form.FormBuilder.prototype.getErrors=function(){return this._errors};
form.FormBuilder.prototype.setErrors=function(errors){this._errors=errors};
/**
 *
 * @returns {form.FormBuilder}
 */
form.createFormBuilder = function (name,model) {
    var f = new form.FormBuilder(name,model);
